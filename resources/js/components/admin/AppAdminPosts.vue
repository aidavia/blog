                ...
                <div class="flex items-center space-x-6">
                    <p class="text-base text-gray-500">
                        <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium"
                              :class="{
                            'bg-green-100 text-green-800': post.published, 'bg-gray-100 text-gray-800': !post.published
                        }">
                            {{ !post.published ? 'Unpublished' : 'Published' }}
                        </span>
                    </p>
                    <div>
                        <a :href="`/admin/posts/${post.uuid}/edit`" class="text-sm font-medium">Edit</a>
                    </div>
                    <div>
    ...
    export default {
        ...
        setup() {
            ...
            const newPost = async () => {
                ...
                window.location.href = `posts/${post.uuid}/edit`;
            }
